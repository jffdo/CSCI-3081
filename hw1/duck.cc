...
[You can not instantiate an object from a abstract class]
*/
...
class Duck {  // The Duck class has been refactored in duck.h
 public:
  // Add the big three to your Duck class: destructor, copy constructor, copy
  // assignment operator. Add comments explaining what each one does, how they
  // differ from one other, and differences between each of these and the
  // default constructor.

  // constructor explain
  Duck() : name("NA"), coolness(0), weight(0) {}
  // user constructor explain
...
// TODO part D: 5 added functions and corresponding comments go here (or in your
// child class files depending on how you want to implement it)
