...
class Drone : public IEntity {
 public:
  ...
  /**
   * @brief Makes the drone aware of an entity request and asks if it can handle
   * it.
   * @param newEntity the entity that the drone is being asked about
   * @return true if drone can pick this up false if not.
   */
  bool Noitfied(IEntity* newEntity);
